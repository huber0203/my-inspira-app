<template>
  <div class="dark">
    <BlackHoleBackground class="min-h-[150vh] flex items-center justify-center custom-center-light">
      <div class="relative flex flex-col items-center justify-center gap-8 px-4 w-full max-w-4xl pt-20">
        <!-- 主標題區域 -->
        <Motion
          as="div"
